...
def copy_and_convert_syslog(host, user, private_key_path, local_destination_path):
    try:
        ...
        local_syslog_path = os.path.join(local_destination_path, f'end-dev_syslog_{host}.txt')
...
if __name__ == "__main__":
    ...
    local_user = 'combo'
    local_private_key_path = '/home/combo/.ssh/id_rsa'  # Adjust the path to your private key

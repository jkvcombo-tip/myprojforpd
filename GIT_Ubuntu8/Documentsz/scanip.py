...
def run_ansible_playbook(inventory_file, playbook_file):
    try:
        inventory_path = os.path.abspath(inventory_file)
        playbook_path = os.path.abspath(playbook_file)
...
if __name__ == "__main__":
    ...
    inventory_file = '/home/combo/Documents/MAIN/inventory.ini'  # Specify the absolute path
    playbook_file = '/home/combo/Documents/MAIN/xpythconnect.yml'  # Specify the absolute path

...
def scan_devices(local_ip):
    try:
        ...
        result = subprocess.run(["sudo", "nmap", '-sn', local_ip + "/24"], capture_output=True, text=True, check=True)
...
def main():
    local_ip = "192.168.1.1"  # Adjust this to a valid local IP in your network
